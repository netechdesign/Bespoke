...
class UtilitaAborts extends React.Component {
    ...
    componentDidMount() {
        ...
        var abortedBar = new ApexCharts(document.querySelector("#UtilitaAborts"), options);
                  abortedBar.render();     
    ...
    render(){ 
        ...
        return(<Aux><div id="UtilitaAbortsrequestLoder" style={{'textAlign': 'center'}}></div><div id='UtilitaAborts'></div></Aux>)
            }
}

export default UtilitaAborts;
