...
/***/ "./resources/js/Back-office/MatrixtelematicsApi/VehicleReport.js":
/*!***********************************************************************!*\
  !*** ./resources/js/Back-office/MatrixtelematicsApi/VehicleReport.js ***!
  \***********************************************************************/
...
global.jQuery = jquery__WEBPACK_IMPORTED_MODULE_8___default.a;
jquery__WEBPACK_IMPORTED_MODULE_8___default.a.DataTable = __webpack_require__(/*! datatables.net-bs */ "./node_modules/datatables.net-bs/js/dataTables.bootstrap.js");
...
var Listdata = /*#__PURE__*/function (_React$Component) {
  _inherits(Listdata, _React$Component);

  var _super = _createSuper(Listdata);
  ...
  function Listdata(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "startlocation", function (data) {
      var address = data.StartStreet;
    ...
    _defineProperty(_assertThisInitialized(_this), "endlocation", function (data) {
      var address = data.EndStreet;
    ...
    _defineProperty(_assertThisInitialized(_this), "setDate", function (data) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setDistance", function (data) {
  ...
  _createClass(Listdata, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, this.props.list.map(function (vl, idx) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, _this2.startlocation(vl)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, _this2.setDate(vl.StartDate)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, _this2.endlocation(vl)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, _this2.setDate(vl.EndDate)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, _this2.setDistance(vl.Distance)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, vl.MaxSpeed), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, vl.RoadSpeedAtMaxSpeed));
      }));
    }
  }]);
...
var ServiceDetail = /*#__PURE__*/function (_React$Component2) {
  _inherits(ServiceDetail, _React$Component2);

  var _super2 = _createSuper(ServiceDetail);
  ...
  function ServiceDetail(props) {
    ...
    _this3.state = {
      servicesdetails: [],
      starttime: '20201108010100',
      endtime: '20201110235900'
    };
    return _this3;
  }
  ...
  _createClass(ServiceDetail, [{
    ...
    value: function componentDidMount() {
      ...
      var _ref = localStorage.getItem('vehicleApi') ? JSON.parse(localStorage.getItem('vehicleApi')) : 'Null',
          access_token = _ref.access_token;

      var serviceID = this.props.serviceid;
      var starttime = this.props.start_date;
      var endtime = this.props.end_date;
      axios__WEBPACK_IMPORTED_MODULE_7___default.a.get('https://restapi.matrixtelematics.com/apioauth/v4/journey?serviceID=' + serviceID + '&from=' + starttime + '&to=' + endtime + '&showTowJourney=False&msgType=0', {
        headers: {
        ...
        if (res.data) {
          _this4.setState({
            servicesdetails: [].concat(_toConsumableArray(_this4.state.servicesdetails), [res.data])
          });
        }
      });
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Table"], {
        ref: "tbl",
        striped: true,
        hover: true,
        responsive: true,
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("thead", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Start Location"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Start Date"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "End Location"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "End Date"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Distance"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Max Speed"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Road Speed At MaxSpeed"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null, this.state.servicesdetails.map(function (vl, idx) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Listdata, {
          list: vl
        });
      }))));
    }
...
var ServiceData = /*#__PURE__*/function (_React$Component3) {
  _inherits(ServiceData, _React$Component3);

  var _super3 = _createSuper(ServiceData);
  ...
  _createClass(ServiceData, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_hoc_Aux__WEBPACK_IMPORTED_MODULE_5__["default"], null, this.props.services.map(function (item, indx) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Col"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Card"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Card"].Header, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Card"].Title, {
          as: "h6"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, "Service ID :"), " ", item.serviceID, "\xA0\xA0\xA0\xA0\xA0", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, "Registration :"), " ", item.vehicleRegistration)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Card"].Body, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ServiceDetail, {
          start_date: _this5.props.start_date,
          end_date: _this5.props.end_date,
...
var VehicleReport = /*#__PURE__*/function (_React$Component4) {
  _inherits(VehicleReport, _React$Component4);

  var _super4 = _createSuper(VehicleReport);

  function VehicleReport(props) {
    var _this6;

    _classCallCheck(this, VehicleReport);

    _this6 = _super4.call(this, props);

    _defineProperty(_assertThisInitialized(_this6), "getToken", function () {
      axios__WEBPACK_IMPORTED_MODULE_7___default.a.post('https://restapi.matrixtelematics.com/OAuth/token', {
        "client_id": 0,
        "grant_type": 'password',
        "username": 'sandeep@itsupportpeople.co.uk',
        "password": 'aerk!3w92GZ79cR'
      }, {
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json'
        ...
        if (res.data.access_token) {
          localStorage.setItem('vehicleApi', JSON.stringify(res.data)); // this.getservicesList();
        }
      });
    });

    _defineProperty(_assertThisInitialized(_this6), "getservicesList", function (e, formData, inputs) {
      e.preventDefault();

      var _ref2 = localStorage.getItem('vehicleApi') ? JSON.parse(localStorage.getItem('vehicleApi')) : 'Null',
      ...
      axios__WEBPACK_IMPORTED_MODULE_7___default.a.get('https://restapi.matrixtelematics.com/apioauth/v4/servicestatuslite?groupID=37747', {
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
          'Authorization': 'Bearer ' + access_token
    ...
    _defineProperty(_assertThisInitialized(_this6), "startDateChange", function (e) {
    ...
    _defineProperty(_assertThisInitialized(_this6), "endDateChange", function (e) {
      var today = new Date(e);
      var dd = today.getDate();
      var mm = today.getMonth() + 1;
      var yyyy = today.getFullYear();
    ...
    _this6.state = {
      servicesdata: [],
      start_date: '20201108010100',
      end_date: '20201110235900'
    };
    return _this6;
  }

  _createClass(VehicleReport, [{
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      }), "Search "))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Card"].Body, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        id: "monday_view",
        style: {
          'textAlign': 'center'
        }
      }), this.state.servicesdata.map(function (item, indx) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ServiceData, {
          start_date: _this7.state.start_date,
          end_date: _this7.state.end_date,
          services: item
        });
      }))))));
    }
...
/* harmony default export */ __webpack_exports__["default"] = (VehicleReport);
