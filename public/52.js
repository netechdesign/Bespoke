...
/* harmony import */ var _CheckPermission__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../CheckPermission */ "./resources/js/CheckPermission.js");
...
var Role = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Role, [{
    ...
    value: function componentDidMount() {
      ...
      var Ischeck = pages[0]['role'].filter(function (v, i) {
        if (v['page_name'] == 'show') {
          if (v['Ischeck']) {
            return v;
          }
      ...
      if (Ischeck.length == 0) {
        history.goBack();
        pnotify_dist_es_PNotify__WEBPACK_IMPORTED_MODULE_4__["default"].error({
...
/***/ "./resources/js/CheckPermission.js":
/*!*****************************************!*\
  !*** ./resources/js/CheckPermission.js ***!
  \*****************************************/
/*! exports provided: default */
...
var CheckPermission = /*#__PURE__*/function (_React) {
  _inherits(CheckPermission, _React);

  var _super = _createSuper(CheckPermission);

  function CheckPermission() {
    _classCallCheck(this, CheckPermission);

    return _super.apply(this, arguments);
  }

  _createClass(CheckPermission, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      /*   
...
/* harmony default export */ __webpack_exports__["default"] = (CheckPermission);
