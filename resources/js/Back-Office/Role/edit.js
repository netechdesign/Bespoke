...
class edit  extends React.Component{
    ...
    handleSubmit = (e, formData, inputs) => {
        ...
        axios.post(
            baseurl+'/api/role/'+this.state.id,
    ...
    PemissionGet = (e) =>{
      const id = this.state.id;
        ...
        axios.get(
            baseurl+'/api/role/'+id+'/edit',
            {headers:{'Authorization':'Bearer '+auth_token}} 
        ).then(res =>{
                        if(res.data.success){
                            
                          const parmissions =  res.data.data.parmissions;
                           this.setState({name:res.data.data.name,permission:parmissions})
        ...
        return( <Aux>
                <Row>
                    <Col>
                        <Card>
                            <Card.Header>
                                <Card.Title as="h5">Edit Role</Card.Title>
