...
class Mpostcode extends React.Component {
            ...
            $('#data-table-responsive tbody').on('click', '.deletefile', function () {
                ...
                MySwal.fire({
                    ...
                    if (willDelete.value) {
                        ...
                        const baseurl= window.location.origin;
                        axios.post(
                            baseurl+'/api/m25_postcode/'+id,{_method: 'delete'},
                            {
                                headers:{'Authorization':'Bearer '+auth_token}
                            } 
                        ).then(res =>{
            ...
            <Row>
                <Col>
                    <AnimatedModal animation='slideInDown' showModal={this.state.showModal} modalClosed={() => this.setState({ showModal: false })}>
                        <Card>
                        <Card.Header>
                            <Card.Title as="h5">Add Inner M25 Postcode</Card.Title>
                        </Card.Header>
                        <Card.Body>
                        ...
                        <ValidationForm onSubmit={this.handleSubmit} onErrorSubmit={this.handleErrorSubmit}>
                                <Form.Row>
                                        ...
                                        <Form.Group as={Col} md="6">
                                            <Form.Label htmlFor="engineer_name">Postcode</Form.Label>
                                            <TextInput
                                                name="name"
                                                id="name"
                        ...
                        <Card>
                        <Card.Header>
                            <Card.Title as="h5">Inner M25 Postcode List</Card.Title>
