...
class UtilitaList extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state={start_date:'',end_date:'',baseurl:window.location.origin+'/export'}
    }
        handleChange = (e) => {
            this.setState({
                      ...
                      <Card>
                            ...
                            <Form.Row> 
                                <Form.Group as={Col} md="2">
                                    ...
                                    <Datetime dateFormat="D/M/Y" timeFormat={false} errorMessage={{required:"start_date is required"}}  inputProps={{required:'required',name:"start_date",placeholder: 'Select Date',autoComplete:'off'}} />
                                </Form.Group>
                                
                                <Form.Group as={Col} md="2">
                                    <Form.Label htmlFor="end_date">End Date</Form.Label>
                                    <Datetime dateFormat="D/M/Y" timeFormat={false} required="required" errorMessage={{required:"end_date is required"}} onChange={this.handleChange} inputProps={{required:'required',name:"end_date",placeholder: 'Select Date',autoComplete:'off'}} />
                                </Form.Group>
                                <Form.Group as={Col} md="2">
                                    <Form.Label htmlFor="Download"> &nbsp;</Form.Label>
                                    <Button type="submit" style={{'marginTop':'28px'}} className="primary" >Download</Button>
