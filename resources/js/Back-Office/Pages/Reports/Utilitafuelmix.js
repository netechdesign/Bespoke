...
class Utilitafuelmix extends React.Component {
    ...
    graphload = () => {
     ...
     if(this.props.match.params.id){
      ...
      axios.post(baseurl+'/api/utilita/fuelmix',data,{headers:{'Authorization':'Bearer '+auth_token}}).then(res =>{
