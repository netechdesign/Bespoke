...
class MorrisonInstallsFuels extends React.Component {
...
//series
        ...
        axios.post(baseurl+'/api/dashboardmorrison',data,{headers:{'Accept':'application/json','Authorization':'Bearer '+auth_token}}).then(res =>{
...
var abortedBar = new ApexCharts(document.querySelector("#MorrisonInstallsFuels"), options);
          abortedBar.render();     
    ...
    render(){ 
        ...
        return(<Aux><div id="MorrisonrequestLoder" style={{'textAlign': 'center'}}></div><div id='MorrisonInstallsFuels'></div></Aux>)
            }
}

export default MorrisonInstallsFuels;