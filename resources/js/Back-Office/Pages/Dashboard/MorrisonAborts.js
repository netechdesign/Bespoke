...
class MorrisonAborts extends React.Component {
    ...
    componentDidMount() {
        ...
        var abortedBar = new ApexCharts(document.querySelector("#MorrisonAborts"), options);
                  abortedBar.render();     
    ...
    render(){ 
        ...
        return(<Aux><div id="MorrisonAbortsrequestLoder" style={{'textAlign': 'center'}}></div><div id='MorrisonAborts'></div></Aux>)
            }
}

export default MorrisonAborts;
