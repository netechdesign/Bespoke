...
class ServiceDetail extends React.Component{
    ...
    render(){
        return(<div class="table-responsive"><table class="table-columned table">
                  <tr><td>Start Location</td><td>Start Date</td><td>End Location</td><td>End Date</td><td>Distance</td><td>Max Speed</td></tr>
                 {
