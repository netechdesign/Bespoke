       ...
       @foreach($data as $k =>$vl)
        ...
        @foreach($vl as $ek =>$evl)
                  <tr>
                      ...
                      <td style="border: solid 1px;">{{$evl->week_5}}</td>
                      <td style="border: solid 1px;">{{$evl->week_1+$evl->week_2+$evl->week_3+$evl->week_4+$evl->week_5}} </td>
            ...
            <th style="border: solid 1px;" width="5%">{{$week_1}}</th>
                ...
                <th style="border: solid 1px;" width="5%">{{$week_5}}</th>
                <th style="border: solid 1px;" width="5%">{{$total}}</th>
       ...
       @foreach($data as $k =>$vl)
        ...
        @foreach($vl as $ek =>$evl)
                  <tr>
                      ...
                      <td style="border: solid 1px;">{{$evl->Mon+$evl->Tue+$evl->Wed+$evl->Thu+$evl->Fri+$evl->Sat+$evl->Sun}} </td>
       ...
       @foreach($data as $k =>$vl)
        ...
        @foreach($vl as $ek =>$evl)
                  <tr>
                      ...
                      <td style="border: solid 1px;">{{$evl->Jan+$evl->Feb+$evl->Mar+$evl->Apr+$evl->May+$evl->Jun+$evl->Jul+$evl->Aug+$evl->Sep+$evl->Oct+$evl->Nov+$evl->Dec}} </td>
            ...
            <tr>
                ...
                <th style="border: solid 1px;" width="5%">{{$Jan}}</th>
                <th style="border: solid 1px;" width="5%">{{$Feb}}</th>
                <th style="border: solid 1px;" width="5%">{{$Mar}}</th>
                <th style="border: solid 1px;" width="5%">{{$Apr}}</th>
                <th style="border: solid 1px;" width="5%">{{$May}}</th>
                <th style="border: solid 1px;" width="5%">{{$Jun}}</th>
                <th style="border: solid 1px;" width="5%">{{ $Jul}}</th>
                <th style="border: solid 1px;" width="5%">{{$Aug}}</th>
                <th style="border: solid 1px;" width="5%">{{$Sep}}</th>
                <th style="border: solid 1px;" width="5%">{{$Oct}}</th>
                <th style="border: solid 1px;" width="5%">{{$Nov}}</th>
