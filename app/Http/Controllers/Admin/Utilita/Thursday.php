<?php
namespace App\Http\Controllers\Admin\Utilita;
use App\User;
use App\Http\Controllers\Controller;
use App\Models\Utilita_job;

class Thursday extends Controller
{
    public $data;
        ...
        $InDayInstalls['Aborts_Check_Comms'][$vl->parent_engineer][$vl->engineer] = $InDayInstalls['Aborts_Check_Comms'][$vl->parent_engineer][$vl->engineer]+1;
         ...
         // dd($InDayInstalls0);
          ...
          // dd($InDayInstalls0);
            ...
            return view('utilitaview', ['data' => $InDayInstalls,'table1'=>$InDayInstalls0,'on_site_time'=>$on_site_time,'show_day'=>'Thursday']);
        }
